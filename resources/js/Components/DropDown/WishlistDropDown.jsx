...
import { TrashIcon, EyeIcon } from "@heroicons/react/24/outline"; // <- make sure you have heroicons installed
...
export default function WishlistDropDown({ dropdownOpen, wishlists }) {
    ...
    return (
        <>
            <div
                className={clsx(
                    "absolute right-0 h-96 top-[85px] w-[22rem] bg-white overflow-y-scroll shadow-xl transform transition-all duration-500 ease-in-out",
                        ...
                        {wishlists.map((wishlist) => (
                            ...
                            >
                                ...
                                <div className="flex flex-col items-center gap-2">
                                    {/* View Product Button */}
                                    <button
                                        onClick={() => viewProduct(wishlist.id)}
